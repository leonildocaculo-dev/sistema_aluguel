...
export function SearchResultsClient() {
  ...
  const { data: propertiesData, isLoading } = useQuery({
    queryKey: ['searchProperties', queryParam, guestsParam, priceRange, selectedTypes, sortOrder],
      ...
      <div className="container mx-auto max-w-[var(--container-width)] py-8 px-4 flex flex-col md:flex-row gap-8">
        ...
        <aside className="w-full md:w-1/4 lg:w-1/5 flex-shrink-0">
          <div className="sticky top-24 bg-surface rounded-xl border border-border p-5 shadow-sm">
            ...
            {/* Amenities Filter (Visual Only for MVP, can be hooked up to API later) */}
            <div className="mb-8">
        ...
        <main className="flex-1">
          ...
          {displayProperties.length > 0 && propertiesData?.next_page_url && (
