      ...
      <div className="max-w-4xl mx-auto">
        ...
        {step === 'success' && (
          <div className="bg-surface/80 border border-green-500/30 rounded-3xl p-12 text-center relative overflow-hidden backdrop-blur-xl">
            ...
            <button onClick={() => router.push('/my-reservations')} className="bg-white text-black px-6 py-3 rounded-xl font-medium">
              Ver Minhas Reservas
            </button>
          </div>
        )}
          ...
          <div className="bg-surface border border-white/10 rounded-3xl p-8 text-center max-w-2xl mx-auto">
            ...
            {form.payment_method === 'manual' && (
              <div className="space-y-6">
                ...
                <button onClick={() => router.push('/my-reservations')} className="bg-primary-600 hover:bg-primary-500 text-white px-6 py-3 rounded-xl font-medium mt-4">
